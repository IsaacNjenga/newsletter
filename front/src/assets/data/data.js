...
export const homeFurnitureTags = [
  { id: 1, name: "Sofas" },
  { id: 2, name: "Beds" },
  { id: 3, name: "Mattresses" },
  { id: 4, name: "Dining tables" },
  { id: 5, name: "Chairs" },
  { id: 6, name: "Desks" },
  { id: 7, name: "Bookshelves" },
  { id: 8, name: "Wardrobes" },
  { id: 9, name: "Coffee tables" },
  { id: 10, name: "TV stands" },
  { id: 11, name: "End tables" },
  { id: 12, name: "Ottomans" },
  { id: 13, name: "Recliners" },
  { id: 14, name: "Sectional sofas" },
  { id: 15, name: "Loveseats" },
  { id: 16, name: "Armchairs" },
  { id: 17, name: "Bar stools" },
  { id: 18, name: "Patio furniture" },
  { id: 19, name: "Outdoor furniture" },
  { id: 20, name: "Rugs" },
];

export const officeFurnitureTags = [
  { id: 1, name: "Office chairs" },
  { id: 2, name: "Desks" },
  { id: 3, name: "Executive desks" },
  { id: 4, name: "Conference tables" },
  { id: 5, name: "Filing cabinets" },
  { id: 6, name: "Bookshelves" },
  { id: 7, name: "Office sofas" },
  { id: 8, name: "Waiting room chairs" },
  { id: 9, name: "Reception desks" },
  { id: 10, name: "Ergonomic chairs" },
  { id: 11, name: "Standing desks" },
  { id: 12, name: "Office tables" },
  { id: 13, name: "Whiteboards" },
  { id: 14, name: "Bulletin boards" },
  { id: 15, name: "Shelving units" },
];
...
export const electronicsTags = [
  ...
  { id: 7, name: "Speakers" },
  { id: 8, name: "TVs" },
  { id: 9, name: "Gaming consoles" },
  { id: 10, name: "Cameras" },
  { id: 11, name: "Printers" },
  { id: 12, name: "Scanners" },
  { id: 13, name: "Projectors" },
  { id: 14, name: "Monitors" },
  { id: 15, name: "Keyboards" },
  { id: 16, name: "Mice" },
  { id: 17, name: "Routers" },
  { id: 18, name: "Modems" },
  { id: 19, name: "Smart home devices" },
  { id: 20, name: "Virtual reality headsets" },
];

export const secondHandItemsTags = [
  { id: 1, name: "Gently used furniture" },
  { id: 2, name: "Pre-owned electronics" },
  { id: 3, name: "Vintage items" },
  { id: 4, name: "Antique furniture" },
  { id: 5, name: "Collectibles" },
  { id: 6, name: "Second-hand clothing" },
  { id: 7, name: "Accessories" },
  { id: 8, name: "Jewelry" },
  { id: 9, name: "Handbags" },
  { id: 10, name: "Shoes" },
  { id: 11, name: "Toys" },
  { id: 12, name: "Baby gear" },
  { id: 13, name: "Sports equipment" },
  { id: 14, name: "Musical instruments" },
  { id: 15, name: "Artwork" },
];

export const accessoriesTags = [
  { id: 1, name: "Lighting fixtures" },
  { id: 2, name: "Decorative items" },
  { id: 3, name: "Rugs" },
  { id: 4, name: "Curtains" },
  { id: 5, name: "Blinds" },
  { id: 6, name: "Wall art" },
  ...
  { id: 11, name: "Vases" },
  { id: 12, name: "Planters" },
  { id: 13, name: "Kitchen utensils" },
  { id: 14, name: "Cookware" },
  { id: 15, name: "Dinnerware" },
  { id: 16, name: "Glassware" },
  { id: 17, name: "Silverware" },
  { id: 18, name: "Bedding" },
];
