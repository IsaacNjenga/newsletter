    ...
    <div className="home-container">
        ...
        <div className="product-grid">
          <div className="product-card">
            <div className="image-placeholder">
              <img src={sofa} alt="Modern Sofa Set" className="product-image" />
            </div>
          ...
          <div className="product-card">
            <div className="image-placeholder">
              <img src={coffee} alt="Glass Coffee Table" className="product-image" />
            </div>
      ...
      <section className="discounts">
        ...
        <div className="product-grid">
          <div className="product-card">
            <div className="image-placeholder">
              <img src={recliner} alt="Recliner Chair" className="product-image" />
            </div>
          ...
          <div className="product-card">
            <div className="image-placeholder">
              <img src={wooden} alt="Wooden Dining Set" className="product-image" />
            </div>
      ...
      <section className="special-offers">
        ...
        <div className="product-grid">
          <div className="product-card">
            <div className="image-placeholder">
              <img src={outdoor} alt="Outdoor Lounge Set" className="product-image" />
            </div>
          ...
          <div className="product-card">
            <div className="image-placeholder">
              <img src={luxury} alt="Luxury Office Chair" className="product-image" />
            </div>
